...
open class ISPoint {
    ...
    public init(title:String, description:String, pointColor:UIColor, lineColor:UIColor,textColor:UIColor, touchUpInside:Optional<(_ point:ISPoint) -> Void>, fill:Bool) {
        self.title = title
    ...
    public convenience init(title:String, description:String, touchUpInside:Optional<(_ point:ISPoint) -> Void>) {
        ...
        self.init(title: title, description: description, pointColor: defaultColor, lineColor: defaultColor,textColor : defaultColor, touchUpInside: touchUpInside, fill: false)
    }
